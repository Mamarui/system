    ...
    <el-container class="container">
        ...
        <el-main class="main">
            <el-table :data="tableData" tooltip-effect="dark" style="width: 100%" border>
                <el-table-column prop="orderuser" label="订单号" align="center"></el-table-column>
                ...
                <el-table-column prop="business" label="商家账号" align="center"></el-table-column>
                <el-table-column prop="businessincome" label="商家收入(元)" align="center"></el-table-column>
