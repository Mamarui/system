    ...
    <el-container class="container">
        <el-header class="header">
            <el-form :inline="true" :model="searchForm" class="form">
                ...
                <el-form-item label="到账状态">
                    <el-select v-model="searchForm.transfer_status">
                        <el-option label="全部" value=""></el-option>
                        <el-option :label="item" :value="index" v-for="(item,index) in transfer_status" :key="index"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
                    <el-input v-model="searchForm.bkys" placeholder="请输入订单号/商家名称"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-main class="main">
            <el-table :data="tableData" tooltip-effect="dark" style="width: 100%" border>
                ...
                <el-table-column prop="merchant_name" label="中介" align="center"></el-table-column>
                <el-table-column prop="broker_fee_ratio" label="返佣比例" align="center"></el-table-column>
                <el-table-column prop="bank_account" label="返佣账号" align="center"></el-table-column>
                <el-table-column prop="broker_fee" label="返佣金额(元)" align="center"></el-table-column>
                <el-table-column prop="transfer_status" label="到账状态" align="center"></el-table-column>
...
export default {
    ...
    methods:{
        ...
        /** 获取列表 */
        getList(){
            requestData('/api/capi/broker/commission/list',{
                ...this.searchForm
            },'get').then((res)=>{
                if(res.status==200){
